...
<body>
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="ht-console">
                <div class="ht-user">
                	<shiro:hasRole name="admin">
                		<img src="${myImages}/Logo_40.png" />
                    	<a class="ht-user-name">超级管理员</a>
                	</shiro:hasRole>
                	<shiro:hasRole name="student">
                		<img src="${myImages}/Logo_40.png" />
                    	<a class="ht-user-name">普通用户</a>
                	</shiro:hasRole>
                	<shiro:notAuthenticated>
                		<img src="${myImages}/Logo_40.png" />
                    	<a class="ht-user-name">游客</a>
                	</shiro:notAuthenticated>
                </div>
            </div>
            <span class="sys-title">图书后台管理系统</span>
            <ul class="ht-nav">
                   ...
                   <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd><a href="javascript:;" data-url="datalist.jsp" data-id="5">网站公告</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.jsp" data-id="6">更新日志</a></dd>
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">图书后台管理系统 - Design By LY</p>
        </div>
