...
layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    function showLogin() {
        ...
        loginHtml += '<input type="text" name="username" lay-verify="username" placeholder="请输入账号" value="admin" autocomplete="off" class="layui-input">';
        loginHtml += '</div>';
        loginHtml += '</div>';
        loginHtml += '<div class="layui-form-item">';
        ...
        loginHtml += '<div class="layui-input-inline pm-login-input">';
        loginHtml += '<input type="text" placeholder="人机验证，百度螺丝帽" value="" autocomplete="off" class="layui-input">';
        loginHtml += '</div>';
        loginHtml += '</div>';
